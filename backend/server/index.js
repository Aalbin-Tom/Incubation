...
app.use('/admin/decline',userRotes)
app.use('/admin/approvedlist',userRotes)
app.use('/admin/declinedlist',userRotes)
app.use('/admin/addroom',userRotes)
app.use('/admin/bookslot',userRotes)
app.use('/admin/asignslot',userRotes)
app.use('/admin/viewdata',userRotes)
